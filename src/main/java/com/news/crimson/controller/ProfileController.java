...
public class ProfileController {
	...
	public ResponseEntity<String> blockProfile(@RequestParam("userId") Integer userId,
	...
	public ResponseEntity<String> unblockProfile(@RequestParam("userId") Integer userId,
			@RequestParam("blockId") Integer blockId) {
	...
	public ResponseEntity<String> followProfile(@RequestParam("userId") Integer userId,
	...
	public ResponseEntity<String> unfollowProfile(@RequestParam("userId") Integer userId,
			@RequestParam("followerId") Integer followerId) {
	...
	public ResponseEntity<String> addFriend(@RequestParam("userId") Integer userId,
			@RequestParam("friendId") Integer friendId) {
	...
	public ResponseEntity<String> deleteFriend(@RequestParam("userId") Integer userId,
			@RequestParam("friendId") Integer friendId) {
